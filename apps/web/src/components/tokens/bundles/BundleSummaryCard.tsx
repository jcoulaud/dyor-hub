...
export const BundleSummaryCard = ({ bundleData, isLoading }: BundleSummaryCardProps) => {
  ...
  return (
    <div className='relative group'>
      <div className='absolute -inset-0.5 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-300'></div>
      <Card className='relative h-full bg-zinc-900/40 backdrop-blur-sm border-0 rounded-xl overflow-hidden'>
        <div className='absolute inset-0 bg-gradient-to-br from-teal-600/5 to-cyan-800/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
        ...
        <CardContent className='relative pt-2 pb-4'>
          <div className='space-y-1'>
            ...
            <StatItem
              ...
              value={bundleData?.bundles.reduce((sum, bundle) => sum + bundle.unique_wallets, 0)}
              isLoading={isLoading}
