        ...
        <div className='flex items-center justify-between px-4 py-2 bg-zinc-800/30 border-b border-zinc-700'>
          <div className='text-sm font-medium text-white flex items-center'>
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <Info className='h-4 w-4 text-zinc-500 ml-1.5 hover:text-cyan-400 transition-colors' />
                </TooltipTrigger>
                <TooltipContent className='max-w-xs'>
                  <div className='space-y-2'>
                    <p className='text-xs font-semibold text-cyan-400'>What are bundles?</p>
                    <p className='text-xs'>
                      Bundles are coordinated purchases from multiple wallets controlled by the same
                      entity (usually the token team).
                    </p>
                    <p className='text-xs'>
                      They are used to control token supply and manipulate price action. A high
                      bundle percentage (especially currently held) is a potential red flag.
                    </p>
                  </div>
                </TooltipContent>
              </Tooltip>
