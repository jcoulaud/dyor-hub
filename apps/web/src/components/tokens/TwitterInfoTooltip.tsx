...
interface TwitterInfoTooltipProps {
  ...
  ({
    ...
    useEffect(() => {
      const fetchTwitterInfo = async () => {
        ...
        try {
          const data = await tokens.getTwitterInfo(mintAddress);
    ...
    return (
      <div className='relative'>
        ...
        {/* Warning Icon with History Tooltip */}
        {hasUsernameHistory && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
