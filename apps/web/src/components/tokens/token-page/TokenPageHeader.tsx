      ...
      {isLoadingTokenData ? (
        ...
        <>
          ...
          <div className='hidden lg:block'>
            ...
            {sentimentData && onSentimentVote && (
              <div className='p-6 border-b border-zinc-700/50'>
                <h3 className='text-sm font-semibold text-white mb-3'>Token Sentiment</h3>
                <div className='grid grid-cols-3 gap-2'>
                  {/* Bullish Card */}
                  <div
                    className={`flex flex-col items-center justify-center bg-zinc-800/50 rounded-lg p-3 border ${
                      sentimentData?.userSentiment === SentimentType.BULLISH
                        ? 'border-green-500/50 bg-green-900/20'
                        : 'border-transparent hover:border-green-500/20 hover:bg-green-900/10'
                    } transition-all duration-200 cursor-pointer ${
            ...
            <div className='flex-1 p-6'>
              ...
              <TokenExternalLinks tokenAddress={tokenData.mintAddress} className='flex-wrap' />
            </div>

            {/* Search Input */}
            <div className='p-6'>
              <h3 className='text-sm font-semibold text-white mb-3'>Search Token</h3>
              <div className='relative group'>
                {/* Enhanced background glow effect */}
                <div className='absolute -inset-0.5 bg-gradient-to-r from-emerald-500/30 to-teal-500/30 rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300'></div>
