...
export class AddReferralSystem1745606176369 implements MigrationInterface {
  name = 'AddReferralSystem1745606176369';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Use correct column name 'threshold_value'
    await queryRunner.query(
    ...
    // ... (Schema dropping remains the same) ...
    await queryRunner.query(
